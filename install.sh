...
# VS Code ignores chsh and containers block it — exec zsh from .bashrc ensures new terminals open zsh.
...
echo "  2. If BLUEBOX_KB_PAT is not already set as a Codespace secret,"
