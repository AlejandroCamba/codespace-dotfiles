# Generated by Powerlevel10k configuration wizard on 2026-08-11 at 18:28 CEST.
...
# vertical separators, flat heads, flat tails, 1 line, compact, few icons, fluent,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%252F'  # light grey foreground
      local   modified='%178F'  # yellow foreground
      local  untracked='%252F'  # light grey foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=39
